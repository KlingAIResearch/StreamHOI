...
MASTER_ADDR="10.82.120.15"             # IP address of the master node (must be accessible by all nodes)
...
# --- Script arguments ---
CONFIG=configs/longlive_train-1.3b_480P-init.yaml
LOGDIR=/ytech_milm_intern/zhangjiaming09/Video-Causal/ResonInteraction/logs/longlive_train-1.3b_480P-init
mkdir -p $LOGDIR
WANDB_SAVE_DIR=/ytech_milm_intern/zhangjiaming09/Video-Causal/ResonInteraction/wandb
echo "CONFIG=$CONFIG"
...
bash /m2v_intern/zhangjiaming09/Video-Causal/input_gpu.sh 0,1,2,3,4,5,6,7