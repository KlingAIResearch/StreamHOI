...
class SelfForcingModel(BaseModel):
    ...
    def _initialize_inference_pipeline(self):
        ...
        sink_size = getattr(self.args, "model_kwargs", {}).get("sink_size", 1)
        ...
        self.inference_pipeline = SelfForcingTrainingPipeline(
            ...
            sink_size=sink_size,
            whether_set_per_block_sink_size=getattr(self.args, "whether_set_per_block_sink_size", False),
            sink_size_per_block=list(getattr(self.args, "sink_size_per_block", [sink_size] * 30)),
        )
